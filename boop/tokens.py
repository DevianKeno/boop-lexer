...
OPERATORS = {
    ...
    LEFT_ANGLED_BRACKET: 'LOGC_LESS_THAN',
    RIGHT_ANGLED_BRACKET: 'LOGC_GREATER_THAN',
    LEFT_ANGLED_BRACKET + EQUALS: 'LOGC_LESS_OR_EQUAL',
    RIGHT_ANGLED_BRACKET + EQUALS: 'LOGC_GREATER_OR_EQUAL',
